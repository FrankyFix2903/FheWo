================================================================================
 MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: FheWo-Projektübersicht
================================================================================

Der Anwendungs-Assistent hat diese FheWo-Anwendung für Sie 
...
finden, aus denen Ihre FheWo–Anwendung besteht.
...
FheWo.h
    ...
    die CFheWoApp-Anwendungsklasse.

FheWo.cpp
    Dies ist die Hauptquelldatei der Anwendung, die die CFheWoApp-
...
res\FheWo.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "FheWo.rc" 
    enthalten.
...
FheWoDlg.h, FheWoDlg.cpp – das Dialogfeld
    Diese Dateien enthalten Ihre CFheWoDlg–Klasse. Diese Klasse 
    bestimmt das Verhalten des Hauptdialogfelds Ihrer Anwendung. Die Vorlage des 
    Dialogfelds befindet sich in der Datei "FheWo.rc", die in 
...
"StdAfx.h", "StdAfx.cpp"
    ...
    (PCH-Datei) mit dem Namen "FheWo.pch.pch2 und eine 
